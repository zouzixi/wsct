...
<section class="Fsl">
 <ul>
  <li>
   <a href="shop.html" target="_blank" title="调用产品名/店铺名"><img src="${pageContext.request.contextPath}/upload/03.jpg"></a>
   <hgroup>
   <h3>【大明宫】***川菜馆</h3>
   <h4></h4>
   </hgroup>
 ...
 <aside>
  ...
  <div class="C-list">
   <a href="shop.html" target="_blank" title="店铺名称"><img src="${pageContext.request.contextPath}/upload/cc.jpg"></a>
