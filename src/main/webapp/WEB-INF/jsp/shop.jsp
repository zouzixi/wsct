...
<section class="Shop-index">
 <article>
  <div class="shopinfor">
   <div class="title">
    <img src="${pageContext.request.contextPath}/upload/wpjnewlogo.jpg" class="shop-ico">
    <span>含山路外婆家</span>
    <span>
   ...
   <div class="imginfor">
    <div class="shopimg">
     <img src="${pageContext.request.contextPath}/upload/cc.jpg" id="showimg">
      <ul class="smallpic">
       <li><img src="${pageContext.request.contextPath}/upload/cc.jpg" onmouseover="show(this)" onmouseout="hide()"></li>
      </ul>
    </div>
    <div class="shoptext">
     ...
     <a href="#" class="icoa"><img src="${pageContext.request.contextPath}/images/collect.png">收藏店铺（1293）</a>
    ...
    <div class="menutab show">
     <ul class="products">
		<li>
         ...
         <img src="${pageContext.request.contextPath}/upload/01.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
		...
		<li>
		 <a href="detailsp.html" target="_blank" title="酸辣土豆丝">
         <img src="${pageContext.request.contextPath}/upload/02.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
		...
		<li>
		 <a href="detailsp.html" target="_blank" title="酸辣土豆丝">
         <img src="${pageContext.request.contextPath}/upload/04.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
		...
		<li>
		 <a href="detailsp.html" target="_blank" title="酸辣土豆丝">
         <img src="${pageContext.request.contextPath}/upload/03.jpg" class="foodsimgsize">
         </a>
          <a href="#" class="item">
		 <div>
		  <p>酸辣土豆丝</p>
 ...
 <aside>
  ...
  <div class="History">
   ...
   <ul>
    <li>
    <a href="detailsp.html" target="_blank" title="清真川菜馆"><img src="${pageContext.request.contextPath}/upload/cc.jpg"></a>
    <p>
